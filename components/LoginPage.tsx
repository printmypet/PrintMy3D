...
import { User, Key, ArrowRight, LogIn, WifiOff, ArrowLeft } from 'lucide-react';
      ...
      <div className="bg-white w-full max-w-md rounded-2xl shadow-xl overflow-hidden border border-slate-200">
        ...
        <div className="p-8 text-center relative overflow-hidden bg-slate-900">
          ...
          <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none">
            <div className="absolute -top-10 -left-10 w-32 h-32 rounded-full bg-indigo-500 blur-3xl" />
            <div className="absolute bottom-0 right-0 w-40 h-40 rounded-full bg-sky-500 blur-3xl" />
          </div>
        </div>
        ...
        <div className="p-8">
          <div className="mb-6 text-center">
            ...
            <p className="text-slate-500 text-sm">Faça login para acessar o painel.</p>
          </div>
          ...
          {!isOnline && (
            <div className="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-xl text-amber-800 text-sm flex gap-3 items-start">
              ...
              <div>
                <strong className="block mb-1">Modo Offline</strong>
                Configure o Supabase em Admin &gt; Configurações. Login local: <strong>admin</strong> / <strong>passroot</strong>
              </div>
            </div>
          )}
